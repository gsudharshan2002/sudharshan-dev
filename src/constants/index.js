...
export const PROJECTS = [
  {
    title: "Blog Website",
    image: project1,
    description:["The goal of my full-stack blog website project is to gain hands-on experience in building a complete web application using React for the frontend and Node.js/Express for the backend.",
